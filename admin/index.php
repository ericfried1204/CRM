			...
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					...
					<div class="col-md-8">
						...
						<?php $query= mysqli_query($conn,"select * from tblutilizadores where cod_utilizador = '$session_id'")or die(mysqli_error());
			...
			<div class="row pb-10">
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php
						$sql = "SELECT cod_utilizador from tblutilizadores";
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						...
						<div class="user-list">
							<ul>
								<?php
		                         $query = mysqli_query($conn,"select * from tblutilizadores ORDER BY tblutilizadores.cod_utilizador desc limit 4") or die(mysqli_error());
		                         while ($row = mysqli_fetch_array($query)) {
		                         $id = $row['cod_utilizador'];
		                             ?>
				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						...
						<div class="user-list">
							<ul>
								<?php
		                         $query = mysqli_query($conn,"select * from tblutilizadores where role = 'Admin' ORDER BY tblutilizadores.cod_utilizador desc limit 4") or die(mysqli_error());
		                         while ($row = mysqli_fetch_array($query)) {
		                         $id = $row['cod_utilizador'];
		                             ?>
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								<?php $sql = "SELECT tblleaves.id as lid,tblutilizadores.FirstName,tblutilizadores.LastName,tblutilizadores.cod_utilizador,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tblutilizadores on tblleaves.empid=tblutilizadores.cod_utilizador order by lid desc limit 5";
									$query = $dbh -> prepare($sql);
									$query->execute();
									$results=$query->fetchAll(PDO::FETCH_OBJ);
									$cnt=1;
