				...
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-library"></span><span class="mtext">ON</span>
							
						</a>
						<ul class="submenu">
							<li><a href="criaron.php">Criar ON</a></li>
							<li><a href="on.php">Gestão ON</a></li>
						</ul>
					</li>
					<li>
						<a href="clientes.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext">Clientes</span>
						</a>
					</li>
					<li>
